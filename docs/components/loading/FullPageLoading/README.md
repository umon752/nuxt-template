...
原始碼：[FullPageLoading.vue](../../../../app/components/loading/FullPageLoading.vue)

Nuxt 自動匯入名稱為 `LoadingFullPageLoading`。
...
```vue
<LoadingFullPageLoading v-slot="{ label }">
  <LoadingSpinner :label="label" spinner-class="size-10 text-white" />
