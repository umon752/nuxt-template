...
原始碼：[StickyAnchor.vue](../../../app/components/StickyAnchor.vue)

## 基本使用

```vue
<script setup lang="ts">
import type { TStickyAnchorItem } from '~/components/StickyAnchor.vue'
...
```vue
<script setup lang="ts">
import type { TStickyAnchorInstance } from '~/components/StickyAnchor.vue'
